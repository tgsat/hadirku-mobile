...
class AppColor {
  ...
  static const Color yellowPrimary = Color(0xFFFEC100);
  static const Color secondary = Color(0xFFE5C33F);
  ...
  static Color darkContainer = AppColor.white.withOpacity(0.1); // ralat again
